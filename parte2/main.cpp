...
int main()
{
    ...
    auto h2 = new TH1F("h2", "Azimuthal angle distribution", 1000, 0, 2 * pi); //distribuzioni degli angoli azimutali (phi)
    auto h3 = new TH1F("h3", "Polar angle distribution", 500, 0, pi);          // " " " polari (theta)
    auto h4 = new TH1F("h4", "Impulse", 700, 0, 7);                            //impulso
    auto h5 = new TH1F("h5", "Transverse impulse", 600, 0, 6);                 //impulso trasverso (no z component)
    auto h6 = new TH1F("h6", "Energy", 600, 0, 6);                             //energia della particella
    ...
    auto h12 = new TH1F("h12", "From K* Decay", 30, 0, 2);                //massa invariante fra le particelle generate in ogni evento che derivano dal decadimento della risonanza K*
